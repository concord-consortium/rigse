...
#
#   ApplicationRecord.connection_handler.connection_pools["ActiveRecord::Base"].connected?
#
...
# # begin
#   ApplicationRecord.observers = :user_observer
#   ApplicationRecord.instantiate_observers
