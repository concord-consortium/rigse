class API::V1::StudentsController < API::APIController
  ...
  def portal_student_strong_params(params)
    params && params.permit(:grade_level_id, :user_id, :uuid)
  end

  # STRONG_PARAMS_REVIEW: model attr_accessible didn't match model attributes:
  #  attr_accessible:             :can_add_teachers_to_cohorts,                        :confirmation_token, :confirmed_at,                                                                       :email, :email_subscribed,
  #  model attrs:     :asked_age, :can_add_teachers_to_cohorts, :confirmation_sent_at, :confirmation_token, :confirmed_at, :current_sign_in_at, :current_sign_in_ip, :default_user, :deleted_at, :email, :email_subscribed, :encrypted_password,

  #  attr_accessible:             :external_id, :first_name, :have_consent, :last_name,                                     :login, :of_consenting_age, :password, :password_confirmation, :remember_me,       :require_password_reset,
  #  model attrs:                 :external_id, :first_name, :have_consent, :last_name, :last_sign_in_at, :last_sign_in_ip, :login, :of_consenting_age, :password_salt, :remember_created_at, :remember_token, :require_password_reset,

  #  attr_accessible:                                                                               :sign_up_path,              :state
  #  model attrs:                 :require_portal_user_type, :reset_password_token, :sign_in_count, :sign_up_path, :site_admin, :state, :unconfirmed_email, :uuid

  def user_strong_params(params)
    # this is what was auto generated by the script
    ...
    # this is the first pass at the permitted parameters
    params && params.permit(:can_add_teachers_to_cohorts, :confirmation_token, :confirmed_at, :email, :email_subscribed, :external_id,
                            :first_name, :have_consent, :last_name, :login, :of_consenting_age, :password, :password_confirmation,
                            :remember_me, :require_password_reset, :sign_up_path, :state)
  end
end
