    ...
    return (
      <div id="footer">
        <div className="footer-inner">
          <p>
            © { year } <a href="https://concord.org" id="footer_cc_link">The Concord Consortium</a>. All Rights Reserved. The Concord Consortium is a 501(c)(3) nonprofit organization registered in the U.S.
            <br />
