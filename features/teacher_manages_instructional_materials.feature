Feature: Teacher manages instructional materials of a class
  ...
  Scenario: Teacher should see investigation options with the first option selected
    Then I should see an option for "Radioactivity" in the select for Instructional Materials
    And I should see an option for "Plant reproduction" in the select for Instructional Materials
    And I should see an option for "Aerodynamics" in the select for Instructional Materials
    And I should see "Sequence: Radioactivity"

  Scenario: Teacher should see activity name in select
    Then I should see an option for "Algebra" in the select for Instructional Materials

  @javascript
  Scenario: Teacher should be able to switch options
    When I select the option of Instructional Materials with text "Plant reproduction"
  ...
  Scenario: Teacher should be able to see student attempt progress bars
    ...
    And I select the option of Instructional Materials with text "Plant reproduction"
  ...
  Scenario: Teacher should not see teacher only activity in the activity table
    ...
    And I select the option of Instructional Materials with text "Aerodynamics"
