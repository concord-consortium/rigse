Feature: Investigations And Resource Pages can be sorted
  So I can find an investigation or resource page more efficiently
  As a teacher
  I want to sort the investigations or resource pages list
