Feature: Teacher views report from the instructional materials page of a class
  ...
  Scenario: Teacher should be able to toggle names
    ...
    And I click "Hide names" button on report page
    Then Report page should have student name "Student 0" in answered section for the question "a"
    And Report page should have student name "Student 1" in answered section for the question "a"
