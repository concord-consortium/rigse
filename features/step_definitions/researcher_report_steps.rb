...
def modified_report_for(investigation)
  report  = Reports::Detail.new(
    ...
    :url_helpers    => Reports::UrlHelpers.new(:protocol => 'https', :host => 'portal.concord.org')
  )
...
Given /^a mocked remote endpoint url$/ do
  Reports::UrlHelpers.any_instance.should_receive(:remote_endpoint_url).and_return('https://portal.concord.org/dataservice/external_activity_data/1')
end
