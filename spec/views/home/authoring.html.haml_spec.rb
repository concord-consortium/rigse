...
describe "home/authoring.html.haml" do
  before (:each) do
    ...
    @resources_pages = [mock_model(ResourcePage, :name => "RP1", :display_name => 'RP1'),mock_model(ResourcePage, :name => "RP2", :display_name => 'RP1')]
    @resource_pages  = [mock_model(ResourcePage, :name => "RP1", :display_name => 'RP1'),mock_model(ResourcePage, :name => "RP2", :display_name => 'RP1')]
