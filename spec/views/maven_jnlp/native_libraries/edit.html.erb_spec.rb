...
describe "/maven_jnlp_native_libraries/edit.html.erb" do
  ...
  it "renders the edit native_library form" do
    render
    
    response.should have_tag("form[action=#{native_library_path(@native_library)}][method=post]") do
