...
describe "/maven_jnlp_native_libraries/index.html.erb" do
  include MavenJnlp::NativeLibrariesHelper
  
  before(:each) do
    assigns[:maven_jnlp_native_libraries] = [
      stub_model(MavenJnlp::NativeLibrary,
        :uuid => "value for uuid",
        :name => "value for name",
        :main => false,
        :os => "value for os",
  ...
  it "renders a list of maven_jnlp_native_libraries" do
    render
