...
describe "/maven_jnlp_maven_jnlp_families/edit.html.erb" do
  ...
  it "renders the edit maven_jnlp_family form" do
    render
    
    response.should have_tag("form[action=#{maven_jnlp_family_path(@maven_jnlp_family)}][method=post]") do
