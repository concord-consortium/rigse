...
describe ExpectationStemsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "expectation_stems", :action => "update", :id => "1").should == {:path => "/expectation_stems/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "expectation_stems", :action => "destroy", :id => "1").should == {:path => "/expectation_stems/1", :method => :delete}
    end
  end
