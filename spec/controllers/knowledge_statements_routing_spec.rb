...
describe KnowledgeStatementsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "knowledge_statements", :action => "update", :id => 1).should == "/knowledge_statements/1"
    end
  
    it "should map #destroy" do
      route_for(:controller => "knowledge_statements", :action => "destroy", :id => 1).should == "/knowledge_statements/1"
    end
  end
