...
describe GradeSpanExpectationsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "grade_span_expectations", :action => "update", :id => 1).should == "/grade_span_expectations/1"
    end
  
    it "should map #destroy" do
      route_for(:controller => "grade_span_expectations", :action => "destroy", :id => 1).should == "/grade_span_expectations/1"
    end
  end
