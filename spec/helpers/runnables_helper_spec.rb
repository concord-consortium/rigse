...
describe RunnablesHelper do
  ...
  describe ".run_button_for" do
    it "should render a run button for a specified component" do
      helper.run_button_for(@resource_page).should == "<a href=\"http://test.host/resource_pages/1002.jnlp\" class=\"run_link rollover\" title=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/run.png?1295966927\" /></a>"
    end
  end

  describe ".preview_button_for" do
    it "should render a preview button for a specified component" do
      helper.preview_button_for(@resource_page).should == "<a href=\"http://test.host/resource_pages/1004.jnlp\" class=\"run_link rollover\" title=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/preview.png?1295966927\" /></a>"
    end
  end

  describe ".teacher_preview_button_for" do
    it "should render a preview button in techer mode for a given component" do
      helper.teacher_preview_button_for(@resource_page).should == "<a href=\"http://test.host/resource_pages/1006.jnlp?teacher_mode=true\" class=\"run_link rollover\" title=\"Preview the Resource: 'Foo' as a Teacher. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Preview the Resource: 'Foo' as a Teacher. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/teacher_preview.png?1297111962\" /></a>"
    end
  end

  describe ".preview_link_for" do
    it "should render a preview link for a given component" do
      helper.preview_link_for(@resource_page).should == "<a href=\"http://test.host/resource_pages/1008.jnlp\" class=\"run_link rollover\" title=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/preview.png?1295966927\" /></a><a href=\"http://test.host/resource_pages/1008.jnlp\" title=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">preview </a>"
    end

    it "should render a preview link for a given component with parameters" do
      helper.preview_link_for(@resource_page, nil, {:link_text => "run Jeff's Leiderhosen"}).should == "<a href=\"http://test.host/resource_pages/1010.jnlp\" class=\"run_link rollover\" title=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/preview.png?1295966927\" /></a><a href=\"http://test.host/resource_pages/1010.jnlp\" title=\"Preview the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">run Jeff's Leiderhosen</a>"
    end
  end

  describe ".run_link_for" do
    it "should render a run link for a given component" do
      helper.run_link_for(@resource_page).should == "<a href=\"http://test.host/resource_pages/1012.jnlp\" class=\"run_link rollover\" title=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/run.png?1295966927\" /></a><a href=\"http://test.host/resource_pages/1012.jnlp\" title=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">run </a>"
    end

    it "should render a run link for a given component with parameters" do
      helper.run_link_for(@resource_page, nil, {:link_text => "run Biscuits"}).should == "<a href=\"http://test.host/resource_pages/1014.jnlp\" class=\"run_link rollover\" title=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/run.png?1295966927\" /></a><a href=\"http://test.host/resource_pages/1014.jnlp\" title=\"Run the Resource: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">run Biscuits</a>"
    end
