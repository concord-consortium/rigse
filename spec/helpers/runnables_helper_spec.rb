...
describe RunnablesHelper do
  ...
  describe ".preview_link_for" do
    it "should render a preview link for a given component" do
      helper.preview_link_for(@page).should == "<a href=\"http://test.host/pages/1006.jnlp\" class=\"rollover\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Preview the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Preview the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/preview.png?1295966927\" /></a><a href=\"http://test.host/pages/1006.jnlp\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Preview the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">preview </a>"
    end

    it "should render a preview link for a given component with parameters" do
      helper.preview_link_for(@page, nil, {:link_text => "run Jeff's Leiderhosen"}).should == "<a href=\"http://test.host/pages/1008.jnlp\" class=\"rollover\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Preview the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Preview the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/preview.png?1295966927\" /></a><a href=\"http://test.host/pages/1008.jnlp\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Preview the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">run Jeff's Leiderhosen</a>"
    end
  end

  describe ".run_link_for" do
    it "should render a run link for a given component" do
      helper.run_link_for(@page).should == "<a href=\"http://test.host/pages/1010.jnlp\" class=\"rollover\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Run the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Run the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/run.png?1295966927\" /></a><a href=\"http://test.host/pages/1010.jnlp\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Run the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">run </a>"
    end

    it "should render a run link for a given component with parameters" do
      helper.run_link_for(@page, nil, {:link_text => "run Biscuits"}).should == "<a href=\"http://test.host/pages/1012.jnlp\" class=\"rollover\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Run the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\"><img alt=\"Run the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\" src=\"/images/run.png?1295966927\" /></a><a href=\"http://test.host/pages/1012.jnlp\" onclick=\"show_mac_alert($('launch_warning'),false);\" title=\"Run the Page: 'Foo' as a Java Web Start application. The first time you do this it may take a while to startup as the Java code is downloaded and saved on your hard drive.\">run Biscuits</a>"
    end
  end
end
