...
describe Portal::SchoolSelector do
  before(:each) do
    ...
    @district1 = FactoryGirl.create(:portal_district, {:state => "MA", :name => "no district"} )
  end
  ...
  describe "when the user has selected the USA as the country" do
    before(:each) do
      @district2 = FactoryGirl.create(:portal_district, {:state => "MA"} )
      @district3 = FactoryGirl.create(:portal_district, {:state => "NY"} )

      @school1   = FactoryGirl.create(:portal_school, {:district => @district1})
      @school2   = FactoryGirl.create(:portal_school, {:district => @district1})
      @school3   = FactoryGirl.create(:portal_school, {:district => @district2})

      @default_district = FactoryGirl.create(:portal_district,  {:state => nil} )
  ...
  describe "changing values" do
    before(:each) do
      @me_distict = FactoryGirl.create(:portal_district, :state=>'ME')
      @me_school  = FactoryGirl.create(:portal_school, :district => @me_distict)
    ...
    describe "changing the district" do
      before(:each) do
        @changed_district = FactoryGirl.create(:portal_district)
        @params = {
          :country       => 'United States',
          :state         => 'ME',
