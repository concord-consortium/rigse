...
describe Portal::School do
  before(:each) do
    ...
    @school = FactoryGirl.create(:nces_portal_school)
    @virtual_school = FactoryGirl.create(:portal_school)
  end
  ...
  it "can create schools from NCES school data " do
    nces_school = FactoryGirl.create(:portal_nces06_school)
  ...
  describe "ways to find schools" do
    before(:each) do
      @woonsocket_school = FactoryGirl.create(:portal_nces06_school, {
        :SEASCH => 39123,
        :MSTATE => 'RI',
