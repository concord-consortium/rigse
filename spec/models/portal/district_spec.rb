...
describe Portal::District do
  ...
  context '.find_or_create_using_nces_district' do
    it "can create districts from NCES district data " do
      nces_district = FactoryGirl.create(:portal_nces06_district)
  ...
  describe "ways to find districts" do
    before(:each) do
      @woonsocket_district = FactoryGirl.create(:portal_nces06_district, {
          :STID => 39,
          :LSTATE => 'RI',
          :NAME => 'Woonsocket',
      })
      @district = FactoryGirl.create(:portal_district, {
