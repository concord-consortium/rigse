set :stages, %w(
  ...
  itsisu-dev itsisu-staging itsi-aws-staging itsisu-production
  selectmedia
...
namespace :convert do
  ...
  task :itsi_activity_template, :roles => :app do
    run "cd #{deploy_to}/#{current_dir} && bundle exec rake RAILS_ENV=#{rails_env} app:import:force_create_itsi_activity_template --trace"
  end
