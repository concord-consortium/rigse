  ...
  class Application < Rails::Application
    ...
    if $PROGRAM_NAME =~ /rake/ && ARGV.grep(/^db:migrate/).length > 0
      puts "Didn't start observers because you are running: rake db:migrate"
        ...
        begin
          config.active_record.observers = :user_observer, :investigation_observer, :"dataservice/bundle_content_observer", :"admin/project_observer", :"dataservice/periodic_bundle_content_observer", :"genigames_connector/bucket_content_observer"
        rescue
