class NLogoModelsController < ApplicationController
  # GET /n_logo_models
  # GET /n_logo_models.xml
  def index    
    @n_logo_models = NLogoModel.search(params[:search], params[:page], nil)
  ...
  # GET /n_logo_models/1
  # GET /n_logo_models/1.xml
  def show
    @n_logo_model = NLogoModel.find(params[:id])
    if request.xhr?
  ...
  # GET /n_logo_models/new
  # GET /n_logo_models/new.xml
  def new
    @n_logo_model = NLogoModel.new
    if request.xhr?
  ...
  # POST /n_logo_models
  # POST /n_logo_models.xml
  def create
    @n_logo_model = NLogoModel.new(params[:n_logo_model])
  ...
  # DELETE /n_logo_models/1
  # DELETE /n_logo_models/1.xml
  def destroy
    @n_logo_model = NLogoModel.find(params[:id])
    respond_to do |format|
