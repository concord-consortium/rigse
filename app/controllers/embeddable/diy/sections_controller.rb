class Embeddable::Diy::SectionsController < ApplicationController
  ...
  # GET /Embeddable/diy_section/1.xml
  def show
    ...
    if request.xhr?
      ...
      respond_to do |format|
        ...
        format.otml { render :layout => "layouts/embeddable/diy_section" } # diy_section.otml.haml
  ...
  # GET /Embeddable/diy_section/1/print
  def print
    @diy_section = Embeddable::Diy::Section.find(params[:id])
    respond_to do |format|
  ...
  # GET /Embeddable/diy_section/new
  # GET /Embeddable/diy_section/new.xml
  def new
  ...
  # GET /Embeddable/diy_section/1/edit
  def edit
    @diy_section = Embeddable::Diy::Section.find(params[:id])
    if request.xhr?
      render :partial => 'remote_form', :locals => { :diy_section => @diy_section }
  ...
  # POST /Embeddable/diy_section.xml
  def create
    @diy_section = Embeddable::Diy::Section.new(params[:diy_section])
  ...
  # PUT /Embeddable/diy_section/1
  # PUT /Embeddable/diy_section/1.xml
  def update
    cancel = params[:commit] == "Cancel"
    @diy_section = Embeddable::Diy::Section.find(params[:id])
    if request.xhr?
  ...
  # DELETE /Embeddable/diy_section/1
  # DELETE /Embeddable/diy_section/1.xml
  def destroy
    @diy_section = Embeddable::Diy::Section.find(params[:id])
    respond_to do |format|
      format.html { redirect_to(diy_section_url) }
      format.xml  { head :ok }
      format.js
    end
