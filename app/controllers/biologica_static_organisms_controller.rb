class BiologicaStaticOrganismsController < ApplicationController
  # GET /biologica_static_organisms
  # GET /biologica_static_organisms.xml
  def index    
    @biologica_static_organisms = BiologicaStaticOrganism.search(params[:search], params[:page], nil)
  ...
  # GET /biologica_static_organisms/1
  # GET /biologica_static_organisms/1.xml
  def show
    @biologica_static_organism = BiologicaStaticOrganism.find(params[:id])
    if request.xhr?
  ...
  # GET /biologica_static_organisms/new
  # GET /biologica_static_organisms/new.xml
  def new
    @biologica_static_organism = BiologicaStaticOrganism.new
    if request.xhr?
  ...
  # GET /biologica_static_organisms/1/edit
  def edit
    @biologica_static_organism = BiologicaStaticOrganism.find(params[:id])
  ...
  # POST /biologica_static_organisms
  # POST /biologica_static_organisms.xml
  def create
    @biologica_static_organism = BiologicaStaticOrganism.new(params[:biologica_static_organism])
  ...
  # PUT /biologica_static_organisms/1
  # PUT /biologica_static_organisms/1.xml
  def update
    cancel = params[:commit] == "Cancel"
    @biologica_static_organism = BiologicaStaticOrganism.find(params[:id])
    if request.xhr?
      ...
      respond_to do |format|
        if @biologica_static_organism.update_attributes(params[:biologica_static_organism])
  ...
  # DELETE /biologica_static_organisms/1
  # DELETE /biologica_static_organisms/1.xml
  def destroy
    @biologica_static_organism = BiologicaStaticOrganism.find(params[:id])
    respond_to do |format|
