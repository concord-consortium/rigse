class Portal::OfferingsController < ApplicationController
  ...
  def create_saveable(embeddable, offering, learner, answer)
    ...
    when Embeddable::OpenResponse
      saveable_open_response = Saveable::OpenResponse.xfind_or_create_by_learner_id_and_offering_id_and_open_response_id(learner.id, offering.id, embeddable.id)
    ...
    when Embeddable::MultipleChoice
      ...
      if embeddable && choice
        saveable = Saveable::MultipleChoice.xfind_or_create_by_learner_id_and_offering_id_and_multiple_choice_id(learner.id, offering.id, embeddable.id)
