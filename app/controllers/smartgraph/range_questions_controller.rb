class Smartgraph::RangeQuestionsController < ApplicationController
  # GET /smartgraph_range_questions
  # GET /smartgraph_range_questions.xml
  def index    
    @range_questions = Smartgraph::RangeQuestion.search(params[:search], params[:page], nil)
  ...
  # GET /smartgraph_range_questions/1
  # GET /smartgraph_range_questions/1.xml
  def show
    @range_question = Smartgraph::RangeQuestion.find(params[:id])
    if request.xhr?
  ...
  # GET /smartgraph_range_questions/new
  # GET /smartgraph_range_questions/new.xml
  def new
    @range_question = Smartgraph::RangeQuestion.new
    if request.xhr?
  ...
  # GET /smartgraph_range_questions/1/edit
  def edit
    @range_question = Smartgraph::RangeQuestion.find(params[:id])
  ...
  # POST /smartgraph_range_questions
  # POST /smartgraph_range_questions.xml
  def create
    @range_question = Smartgraph::RangeQuestion.new(params[:smartgraph_range_question])
  ...
  # PUT /smartgraph_range_questions/1
  # PUT /smartgraph_range_questions/1.xml
  def update
    cancel = params[:commit] == "Cancel"
    @range_question = Smartgraph::RangeQuestion.find(params[:id])
    if request.xhr?
  ...
  # DELETE /smartgraph_range_questions/1
  # DELETE /smartgraph_range_questions/1.xml
  def destroy
    @range_question = Smartgraph::RangeQuestion.find(params[:id])
    respond_to do |format|
