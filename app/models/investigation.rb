class Investigation < ActiveRecord::Base
  ...
  def self.process_textile_content(textile, split_last_paragraph=false)
    doc = Hpricot(RedCloth.new(textile).to_html)
  ...
  def self.add_data_collector_to_page(page, probe_type, multiple_graphs)
    page_element = DataCollector.create do |d|
      ...
      d.title = d.name
      d.y_axis_label = probe_type.name
  ...
  def self.create_from_itsi(itsi_activity)
    ...
    name = "Introduction"
    section_desc = "ITSI Activities start with a Discovery Question."
    page_desc = ''
    ...
    unless body.empty?
      section, page, page_element = Investigation.create_section_page(name, body, section_desc, page_desc)
    ...
    name = "Standards"
    section_desc = "What standards does this ITSI Activity cover?"
    page_desc = ''
    body = Investigation.process_textile_content(itsi_activity.standards)
    unless body.empty?
      section, page, page_element = Investigation.create_section_page(name, body, section_desc, page_desc)
      investigation.sections << section
    end
    ...
    name = "Materials"
    section_desc = "What materials does this ITSI Activity require?"
    page_desc = ''
    body = Investigation.process_textile_content(itsi_activity.materials)
    unless body.empty?
      section, page, page_element = Investigation.create_section_page(name, body, section_desc, page_desc)
      investigation.sections << section
    end
    ...
    name = "Safety"
    section_desc = "Are there any safety considerations to be aware of in this ITSI Activity?"
    page_desc = ''
    body = Investigation.process_textile_content(itsi_activity.safety)
    unless body.empty?
      section, page, page_element = Investigation.create_section_page(name, body, section_desc, page_desc)
      investigation.sections << section
    end
    ...
    name = "Procedure"
    section_desc = "What procedures should be performed to get ready for this ITSI Activity?."
    page_desc = ''
    ...
    name = "Prediction"
    section_desc = "Have the learner think about and predict the outcome of an experiment."
    page_desc = ''
    ...
    name = "Collect Data"
    section_desc = "The learner conducts experiments using probes and models."
    page_desc = ''
    ...
    name = "Analysis"
    section_desc = "How can learners reflect and analyze the experiments they just completed?"
    page_desc = ''
    body = Investigation.process_textile_content(itsi_activity.analysis)
    unless body.empty?
      section, page, page_element = Investigation.create_section_page(name, body, section_desc, page_desc)
      investigation.sections << section
    end
    ...
    name = "Conclusion"
    section_desc = "What are some reasonable conclusions a learner might come to after this ITSI Activity?"
    page_desc = ''
    body = Investigation.process_textile_content(itsi_activity.conclusion)
    unless body.empty?
      section, page, page_element = Investigation.create_section_page(name, body, section_desc, page_desc)
      investigation.sections << section
    end
    ...
    name = "Further Investigations"
    section_desc = "Think about any further investigations a learner might want to try."
    page_desc = ''
