class Investigation < ActiveRecord::Base
  ...
  def duplicate(new_owner)
    @return_investigation = deep_clone :use_dictionary => true, :never_clone => [:uuid, :created_at, :updated_at, :publication_status], :include => {:activities => {:sections => {:pages => {:page_elements => :embeddable}}}}
