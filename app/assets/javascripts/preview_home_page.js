function preview_home_page(homePageContentId, homePageContent){
    ...
    var formString = '<html>' +
                       ...
                       '</head>' +
                       '<body>' +
                         '<form id="preview_settings_form" action="/home/preview_home_page" method="post" style="display: none;" enctype="application/x-www-form-urlencoded" accept-charset="UTF-8">' +
