...
Rails version 3 has been released but currently this application is still using Rails 2.3.11. The older "Rails Guides for v2.3.8":http://guides.rubyonrails.org/v2.3.8/ is available and is quite useful for getting a good background on this version of Rails.
...
bc. git clone git@github.com:stepheneb/rigse.git xproject
