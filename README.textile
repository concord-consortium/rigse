...
The latest setup scripts have been tested with 1.4.0.RC0 of JRuby, you will need a running mysql
...
h2. Recreating a new application from scratch
...
h2. Creating the sakai integration demo user accounts.
