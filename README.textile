...
<pre>
  <code>
    ...
    # *** JRuby Note:
    # ***
    # *** There is a UI bug when using the gem highline with JRuby
    # *** When highline displays a prompt and asks for input:
    # *** 
    # ***   Accept defaults? (y/n)
    # *** 
    # *** In JRuby that prompt will instead often look like this:
    # *** 
    # ***   Accept defaults? (y/n) stty: stdin isn't a terminal
    # ***   stty: stdin isn't a terminal
    # *** 
    # *** You can ignore this error and enter 'y' and enter.
