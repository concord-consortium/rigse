...
Copy the production database to this file in your local working directory: <code>db/production_data.sql</code>
...
Copy your local copy of the production database _(<code>db/production_data.sql</code>)_ to the staging server database:

<code>
  cap production db:remote_db_upload
</code>
