...
Gems: capistrano, capistrano-ext, ruby-debug19 (oddly, haml too, when deploying ...)
...
rvm install 1.9.2         # install the latest 1.9.2 ruby
rvm list                  # show locally installed Rubies
rvm use 1.9.2             # use it
...
Next time you work on (eg investigations) try:

<pre><code>rvm use ruby-1.8.7-p299@investigations</pre></code>

and you will have only the gems you configured for investigations.
