...
h4. Running a single directory of rspec tests:
...
h4. Running all the feature tests:
...
<pre><code> railroad -o models.dot -M </code></pre>
...
<pre><code>  sudo chmod -R g+w ./cached-copy/</code></pre>
