        ...
        <div className={"cols"}>
          <div className={"portal-pages-collections-page-header col-12"}>
            ...
            <p className={"portal-pages-collections-page-header-info"}>
              Many of our resources are part of collections that are created by our various <a href={"https://concord.org/our-work/research-projects/"} target={"_blank"} rel="noreferrer">research projects</a>. Each collection has specific learning goals within the context of a larger subject area.
            </p>
          </div>
        </div>
