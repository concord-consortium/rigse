...
export default class ShowSiteNotices extends React.Component<any, any> {
  ...
  renderRow (notice: any) {
    const noticeRowId = "admin__site_notice_" + notice.id;
    return (
  ...
  render () {
    ...
    const siteNoticesContainerClasses = [css.siteNoticesListContainer, "webkit_scrollbars"];
    let toggleText = "Hide Notices";
    if (noticeDisplay === "collapsed") {
      siteNoticesContainerClasses.push(css.collapsed);
      toggleText = "Show Notices";
    }
    const siteNoticesContainerClass = siteNoticesContainerClasses.join(" ");
