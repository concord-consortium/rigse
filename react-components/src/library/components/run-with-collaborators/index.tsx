...
var RunWithCollaborators = Component({
  ...
  handleShowDialog: function (e: any) {
    e.preventDefault()
    this.setState({ showingDialog: true })
  },

  handleHideDialog: function (e: any) {
    e.preventDefault()
    this.setState({ showingDialog: false })
  },

  handleSelectCollaborator: function (e: any) {
  ...
  handleAddCollaborator: function (e: any) {
    e.preventDefault()
  ...
  handleRemoveCollaborator: function (collaborator: any) {
    var collaborators = this.state.collaborators
  ...
  renderCollaborators: function () {
    ...
    return (
      <div className={css.collaborators}>
        <ul>
          {collaborators.map(function (collaborator: any) {
            const props = { collaborator: collaborator, handleRemoveCollaborator: self.handleRemoveCollaborator }
  ...
  render: function () {
    ...
    return (
      <span>
        <a target={p.target} href={p.href} className={p.class} onClick={this.handleShowDialog} ref={function (el: any) { self.buttonElement = el }}>{p.label}</a>
