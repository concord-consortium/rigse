...
describe('When I try to render signup select input', () => {
  ...
  it("should render", () => {
    ...
    const selectInput = Enzyme.mount(<Formsy><SelectInput name="test" placeholder="placeholder" loadOptions={loadOptions} /></Formsy>);
    expect(selectInput.html()).toBe(pack(`
      <form>
        <div class="select-input">
          <div class=" css-2b097c-container">
            <div class=" css-yk16xz-control">
              <div class=" css-g1d714-ValueContainer">
                <div class=" css-1wa3eu0-placeholder">placeholder</div>
