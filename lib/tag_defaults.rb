module TagDefaults
  ...
  module ClassMethods
    ...
    def list_bins(opts = {})
      ...
      activities.reject! { |activity| !activity.lightweight? } if lightweight_only
      ...
      if user
        ...
        users_own.reject! { |activity| !activity.lightweight? } if lightweight_only
        ...
        if (user.portal_teacher || user.has_role?("admin") || user.has_role?("manager") || user.has_role?("author"))
          ...
          other_activities.reject! { |activity| !activity.lightweight? } if lightweight_only
