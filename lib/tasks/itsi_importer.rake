  ...
  namespace :import do
    ...
    task :erase_and_import_itsi_activities => :environment do
      ...
      itsi_activities.each do |itsi_activity| 
        ItsiImporter.create_investigation_from_itsi_activity(itsi_activity, itsi_import_user)
      end
    end
    ...
    task :erase_and_import_ccp_itsi_units => :environment do
      ...
      ccp_itsi_project.units.each do |ccp_itsi_unit|
        ItsiImporter.create_investigation_from_ccp_itsi_unit(ccp_itsi_unit, itsi_import_user)
      end
    end
  end
end
