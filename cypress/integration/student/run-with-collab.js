...
describe('Testing logged in student run with collaborator', () => {
    ...
    const STUDENT_01 = {
        fullName: "portal reporttesting4",
        username: "preporttesting4",
        password: "password",
        classname: "New Class",
        resource: "Testing new activity",
        completePercentage: 'width:18.1818%',// 9.09091%',
        collabFullName: "portal reporttesting5",
        collabUsername: "preporttesting5"
    }
